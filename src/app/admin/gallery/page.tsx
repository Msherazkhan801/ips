          ...
          <div className="flex items-center justify-between mb-6 pb-4 border-b border-slate-100">
            <div>
              ...
              <p className="text-xs text-slate-500 mt-0.5">
                Provide an image path/URL or upload a photograph from your device
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <div className="flex items-center gap-4 mb-2">
                    <button
                      ...
                      className={`text-xs font-bold pb-1 border-b-2 transition-all ${
                        uploadMethod === 'url'
                          ? 'border-school-700 text-school-900'
                  ...
                  {uploadMethod === 'url' ? (
                    <input
                      type="text"
                      required={!imageUrl}
                      placeholder="/images/iqra-preschool.jpg or https://..."
                      value={imageUrl}
                      onChange={(e) => setImageUrl(e.target.value)}
                      className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs font-medium focus:ring-2 focus:ring-school-600 focus:bg-white outline-none font-mono"
                    />
                  ) : (
                    <div>
                      <input
                        ...
                        className="w-full text-xs text-slate-500 file:mr-4 file:py-2 file:px-4 file:rounded-xl file:border-0 file:text-xs file:font-bold file:bg-school-50 file:text-school-700 hover:file:bg-school-100 cursor-pointer"
                      />
                    </div>
                  )}
                </div>
              ...
              <div className="flex flex-col justify-between">
                <div>
                  ...
                  <div className="h-64 rounded-2xl overflow-hidden bg-slate-100 border-2 border-dashed border-slate-300 flex items-center justify-center relative group">
                    {imageUrl ? (
                      <img
                        src={imageUrl}
                        alt="Preview"
                      ...
                      <div className="text-center p-6 text-slate-400">
                        ...
                        <p className="text-xs font-medium">Image preview will render here</p>
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div className="pt-4">
                  <button
                    ...
                    className="w-full py-3.5 bg-school-800 hover:bg-school-900 disabled:bg-slate-300 text-white font-bold rounded-xl text-xs uppercase tracking-wider shadow-lg shadow-school-900/10 transition-all flex items-center justify-center gap-2"
                  >
            ...
            <form onSubmit={handleSaveEdit} className="p-6 space-y-4 max-h-[78vh] overflow-y-auto">
              ...
              <div>
                <div className="flex items-center gap-4 mb-1.5">
                  <span className="text-xs font-bold uppercase tracking-wider text-slate-700">Image Source:</span>
                  <button
                    type="button"
                    onClick={() => setEditUploadMethod('url')}
                    className={`text-xs font-bold pb-0.5 border-b-2 transition-all ${
                      editUploadMethod === 'url' ? 'border-school-700 text-school-900' : 'border-transparent text-slate-400'
                    }`}
                  >
                    URL / Path
                  </button>
                  <button
                    ...
                    className={`text-xs font-bold pb-0.5 border-b-2 transition-all ${
                      editUploadMethod === 'file' ? 'border-school-700 text-school-900' : 'border-transparent text-slate-400'
                    }`}
                  >
                    Choose New File
                  </button>
                ...
                {editUploadMethod === 'url' ? (
                  <input
                    ...
                    className="w-full px-3.5 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs font-mono focus:ring-2 focus:ring-school-600 focus:bg-white outline-none"
                  />
                ) : (
                  <div>
                    <input
              ...
              <div>
                ...
                <div className="h-44 rounded-xl overflow-hidden bg-slate-100 border border-slate-200 flex items-center justify-center">
